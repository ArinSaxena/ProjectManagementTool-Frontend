...
// import { ClipboardList, CheckCircle, Loader, ListTodo } from "lucide-react";
...
//           <li className="flex items-center p-2 text-blue-600 bg-blue-100 rounded-lg">
//             <ClipboardList className="mr-2" /> Dashboard
//           </li>
//           <li className="flex items-center p-2 hover:bg-gray-200 rounded-lg">
//             <CheckCircle className="mr-2 text-green-600" /> Completed
//           </li>
//           <li className="flex items-center p-2 hover:bg-gray-200 rounded-lg">
//             <Loader className="mr-2 text-yellow-600" /> In Progress
//           </li>
//           <li className="flex items-center p-2 hover:bg-gray-200 rounded-lg">
//             <ListTodo className="mr-2 text-red-600" /> To-Do
//           </li>
//         </ul>
//       </div> */}
...
//           {/* Task Overview Cards */}
//           <div className="grid grid-cols-4 gap-6">
//             <div className="bg-white p-5 shadow-md rounded-xl flex flex-col items-center border-l-4 border-blue-500">
//               <h2 className="text-md font-semibold text-gray-600">Total Tasks</h2>
//               <p className="text-3xl font-bold text-blue-600">{totalTasks}</p>
//             </div>
//             <div className="bg-white p-5 shadow-md rounded-xl flex flex-col items-center border-l-4 border-green-500">
//               <h2 className="text-md font-semibold text-gray-600">Completed</h2>
//               <p className="text-3xl font-bold text-green-600">{completedTasks}</p>
//             </div>
//             <div className="bg-white p-5 shadow-md rounded-xl flex flex-col items-center border-l-4 border-yellow-500">
//               <h2 className="text-md font-semibold text-gray-600">In Progress</h2>
//               <p className="text-3xl font-bold text-yellow-600">{tasksInProgress}</p>
//             </div>
//             <div className="bg-white p-5 shadow-md rounded-xl flex flex-col items-center border-l-4 border-red-500">
//               <h2 className="text-md font-semibold text-gray-600">To-Do</h2>
//               <p className="text-3xl font-bold text-red-600">{todos}</p>
//             </div>
//           </div>
